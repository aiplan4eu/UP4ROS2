...
from up4ros2 import up4ros2_main

# from up_msgs.srv import AddAction, AddProblem
from up4ros2.ros2_interface_reader import ROS2InterfaceReader  # type: ignore[attr-defined]
from up4ros2.ros2_interface_writer import ROS2InterfaceWriter  # type: ignore[attr-defined]
...
class TestUP4ROS2(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        pass
    ...
    def test_plan_from_file_pddl_no_tt(self):
        ...
        node_test = up4ros2_main.UP4ROS2Node()
        ...
        goal_msg.plan_request.domain = (
            get_package_share_directory("up4ros2") + "/pddl/gripper_domain.pddl"
        )
        goal_msg.plan_request.problem = (
            get_package_share_directory("up4ros2") + "/pddl/gripper_problem_0.pddl"
        )
        ...
        client = ActionClient(
            node_cli, PDDLPlanOneShot, "up4ros2/action/planOneShotPDDL"
        )
        ...
        def get_result_callback(future):
            ...
            node_cli.get_logger().info(
                "Result: success: {0} message:{1}".format(
        ...
        def feedback_callback(feedback_msg):
            ...
            node_cli.get_logger().info("Received feedback: {0}".format(upf_plan))
    ...
    def test_plan_from_file_pddl_tt(self):
        ...
        goal_msg.plan_request.mode = msgs.PDDLPlanRequest.FILE
        goal_msg.plan_request.domain = (
            get_package_share_directory("up4ros2") + "/pddl/domain_tt.pddl"
        )
        goal_msg.plan_request.problem = (
            get_package_share_directory("up4ros2") + "/pddl/problem_tt_1.pddl"
        )
    ...
    def test_plan_robot(self):
        ...
        client = ActionClient(node_cli, PlanOneShot, "up4ros2/action/planOneShot")
    ...
    def test_plan_from_file_pddl_tt_service(self):
        ...
        client = node_cli.create_client(
            PDDLPlanOneShotSrv, "up4ros2/srv/planOneShotPDDL"
        )
        ...
        reader = PDDLReader()
        upf_problem = reader.parse_problem(
            srv.plan_request.domain, srv.plan_request.problem
        )
    ...
    def test_new_problem(self):
        ...
        client = node_cli.create_client(NewProblem, "up4ros2/srv/new_problem")
        while not client.wait_for_service(timeout_sec=1.0):
            self.get_logger().info("service not available, waiting again...")
    ...
    def test_set_get_problem(self):
        ...
        client = node_cli.create_client(SetProblem, "up4ros2/srv/set_problem")
        while not client.wait_for_service(timeout_sec=1.0):
            self.get_logger().info("service not available, waiting again...")
        ...
        client2 = node_cli.create_client(GetProblem, "up4ros2/srv/get_problem")
        while not client.wait_for_service(timeout_sec=1.0):
            self.get_logger().info("service not available, waiting again...")
    ...
    def test_add_set_fluent(self):
        ...
        add_fluent_cli = node_cli.create_client(AddFluent, "up4ros2/srv/add_fluent")
        ...
        set_initial_value_cli = node_cli.create_client(
            SetInitialValue, "up4ros2/srv/set_initial_value"
        )
        ...
        add_goal_cli = node_cli.create_client(AddGoal, "up4ros2/srv/add_goal")
    ...
    def test_add_action(self):
        ...
        add_action_cli = node_cli.create_client(AddAction, "up4ros2/srv/add_action")
    ...
    def test_add_object(self):
        ...
        add_object_cli = node_cli.create_client(AddObject, "up4ros2/srv/add_object")
        ...
        #        client2 = node_cli.create_client(GetProblem, 'up4ros2/get_problem')
        #        while not client.wait_for_service(timeout_sec=1.0):
        #            self.get_logger().info('service not available, waiting again...')
        #
        #        pb_reader = ROS2InterfaceReader()
